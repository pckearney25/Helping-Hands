...
-- ("Kalie", "Smith", "816-555-5432", "ksmith@hey.com"),
-- ("Pat", "Simms", "913-555-2233", "psimms@hey.com"),
-- ("James", "White", "816-555-9876", "jwhite@hey.com"),
-- ("Sam", "Resende", "913-555-7643", "sresende@hey.com"),
-- ("Sonia", "Johnson", "913-555-1198", "sjohnson@hey.com");

-- INSERT INTO organizations (organizer, email, phone_num)
-- VALUES 
-- ("South Baptist Church", "sbc@church.org", "816-326-7643"),
-- ("Westend Ministry", "west@church.org", "816-235-1845"),
-- ("North High School", "nhs@dist.edu", "913-445-8365"),
-- ("Blue Cross", "bchelpers@help.org", "913-234-9264");

-- INSERT INTO users (username, password, hh_role)
-- Values 
-- ("tfranklin@hey.com", "h3llofr@nk", "volunteer"), 
-- ("ksmith@hey.com", "1mK@tieS00", "volunteer"), 
-- ("psimms@hey.com", "p@t1sHere12", "volunteer"), 
-- ("jwhite@hey.com", "H3lp3rJ@mes", "volunteer"), 
-- ("sresende@hey.com", "S@miAm01", "volunteer"), 
-- ("sjohnson@hey.com", "J0hn$0n#!", "volunteer"), 
-- ("sbc@church.org", "SBC!@#123", "organization"), 
-- ("west@church.org", "Min1sry*$", "organization"), 
-- ("nhs@dist.edu", "NHS@#$dist", "organization"), 
-- ("bchelpers@help.org", "blu3Cr0$$001", "organization");
...
-- understand it will be hot outside and to bring sunscreen.  Thank you for your help", "South Babtist Church", "2018-05-31", "12:00");

-- INSERT INTO events (event_name, event_desc, event_loc, event_date, event_time)
-- VALUES ("Car Wash", "Need some volunteers for our fundraiser car wash.  Please
-- understand it will be hot outside and to bring sunscreen.  Thank you for your help", "North High School", "2018-05-27", "12:00");

-- INSERT INTO events (event_name, event_desc, event_loc, event_date, event_time)
-- VALUES ("Filing", "We are remodeling and would love some volunteers to help us organize and file!  Thank you for your help!", "Blue Cross", "2018-05-17", "12:00");
