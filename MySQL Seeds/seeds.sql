...
VALUES (1, 2, '2018-05-15 00:00:00', '2018-05-15 00:00:00'),
       ...
       (5, 1, '2018-05-15 00:00:00', '2018-05-15 00:00:00'),
       (5, 2, '2018-05-15 00:00:00', '2018-05-15 00:00:00'),
       (7, 2, '2018-05-15 00:00:00', '2018-05-15 00:00:00'),
       (6, 3, '2018-05-15 00:00:00', '2018-05-15 00:00:00'),
       (3, 4, '2018-05-15 00:00:00', '2018-05-15 00:00:00'),
       ...
       (2, 5, '2018-05-15 00:00:00', '2018-05-15 00:00:00'),
       (2, 6, '2018-05-15 00:00:00', '2018-05-15 00:00:00');
...
INSERT INTO events
   (event_name, event_desc, event_loc, event_date, event_time, createdAt, updatedAt)
VALUES
   ("Filing", "We are remodeling and would love some volunteers to help us organize and file!  Thank you for your help!", "Blue Cross location 3", "2018-05-17", "12:00",'2018-05-15 00:00:00', '2018-05-15 00:00:00');

   INSERT INTO events
   (event_name, event_desc, event_loc, event_date, event_time, createdAt, updatedAt)
VALUES
   ("Food Drive", "bring some canned food, get a sticker!", "Blue Cross location 1", "2018-05-17", "12:00",'2018-05-15 00:00:00', '2018-05-15 00:00:00');

   INSERT INTO events
   (event_name, event_desc, event_loc, event_date, event_time, createdAt, updatedAt)
VALUES
   ("Free things", "Free things", "North High School", "2018-05-17", "10:00",'2018-05-15 00:00:00', '2018-05-15 00:00:00');

   INSERT INTO events
   (event_name, event_desc, event_loc, event_date, event_time, createdAt, updatedAt)
VALUES
   ("Sew Club", "Need some pants repaired? Come to South Baptist Church, we've got a sewing club that sews for free!", "South Baptist Church", "2018-05-17", "12:00",'2018-05-15 00:00:00', '2018-05-15 00:00:00');
